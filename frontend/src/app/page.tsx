...
export default function HomePage() {
  ...
  useEffect(() => {
    if (hasMeta) trackMetaEvent("ViewContent", { content_type: "landing" });
    if (hasTikTok) trackTikTokEvent("ViewContent", { content_type: "landing" });
  }, []);
...
ttq.page();
          ...
          <div className="space-y-6">
            <div className="mx-auto max-w-xs">
              <PhotoUploader
                ...
                onChange={(f) => { setPersonFile(f); setPersonPhoto(URL.createObjectURL(f)); }}
              />
            </div>
            <button onClick={handleSubmit} disabled={loading || !personFile}
      ...
      <section className="border-t border-zinc-800 py-16 text-center">
        ...
        <p className="text-zinc-500 mb-6 max-w-md mx-auto">
          Ajoute tes produits, génère des essayages virtuels et suis tes statistiques depuis ton tableau de bord.
        </p>
        <Link href="/login"
      ...
      <section className="mx-auto max-w-3xl px-6 py-10 text-center">
        <p className="text-xs text-zinc-600">
          ...
          <Link href="/privacy" className="text-zinc-400 underline underline-offset-2 hover:text-zinc-300">
